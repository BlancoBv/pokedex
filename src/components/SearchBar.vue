...
<template>
    ...
    <div class="dropdown w-full">
        <label class="input input-bordered flex items-center w-48 md:w-auto overflow-clip" for="search-input">
            <input type="text" id="search-input" class="grow" placeholder="Filter by ID or name!" :value="value"
                @input="handleInput" tabindex="0" />
